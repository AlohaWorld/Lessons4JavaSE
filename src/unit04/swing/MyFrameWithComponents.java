...
public class MyFrameWithComponents {
	public static void main(String[] args) {
		...
		frame.add(new JButton("Close"));  // equivalent to frame.getContentPane().add()
		...
		frame.setLocationRelativeTo(null); // New since JDK 1.4, put the window to the center of the screen
	}
}

...
class TimerListener implements ActionListener { //Step1 写一个Listener类（实现ActionListener接口）
  public void actionPerformed(ActionEvent e) {  //Step2 在Listener中重写事件处理函数actionPerformed

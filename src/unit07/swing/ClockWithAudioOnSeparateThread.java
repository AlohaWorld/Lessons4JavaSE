...
public class ClockWithAudioOnSeparateThread extends JFrame implements ActionListener {
  ...
  public static void main(String[] args) {
    try {
      ClockWithAudioOnSeparateThread clock = new ClockWithAudioOnSeparateThread();
      clock.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
      clock.setTitle("ClockWithAudioOnSeparateThread");
      clock.setSize(400, 360);
